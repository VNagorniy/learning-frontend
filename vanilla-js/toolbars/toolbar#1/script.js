...
// ONLY IF CSS API ISN'T SUPPORTED
				...
				.fromTo(
					...
					{ scale: 0.25, '--blur': 1, '--parallax': 0 },
					{
						...
						scrollTrigger: {
							...
							scroller,
							horizontal: !vertical,
							end: `${vertical ? 'bottom' : 'right'} ${dock[vertical ? 'offsetHeight' : 'offsetWidth'] - 1.5 * 16}`,
							start: `${vertical ? 'top' : 'left'} ${dock[vertical ? 'offsetHeight' : 'offsetWidth']}`,
							scrub
						}
					}
				);
